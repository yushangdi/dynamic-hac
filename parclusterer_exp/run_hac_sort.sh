...
datasets=("mnist") #mnist "aloi" "ilsvrc_small"

for dataset in ${datasets[@]}
do
  input_data="$EXP_ROOT/data/${dataset}/${dataset}.scale.sorted.fvecs"
  ground_truth="$EXP_ROOT/data/${dataset}/${dataset}.scale.sorted_label.bin"
  clustering="$EXP_ROOT/results/parhac_sort/${dataset}"
  output_file="$EXP_ROOT/results/results_hac_sort/${dataset}"
  output_knn="$EXP_ROOT/results/knn_sort/${dataset}/knn_${dataset}"
